                            ...
                            @endif
                                ...
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <input type="email" name="email" id="" class="form-control form-control-lg" value="{{old('email')}}" autocomplete="off"/>
                                        <label class="form-label" for="">Email</label>
                                        <span> @error ('email') {{$message}} @enderror</span>
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <input type="password" name="password" id="" class="form-control form-control-lg" value="{{old('password')}}" autocomplete="off"/>
